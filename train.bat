...
REM Reduce CUDA fragmentation so the world-model eval fits alongside the resident
REM training model on a tight GPU (matches train.sh). Respect an existing override.
